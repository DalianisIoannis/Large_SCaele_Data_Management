...
# data file paths
PATHS = [
    "hdfs://master:9000/home/user/Assignment/Data/parquet/Crime_Data_from_2010_to_2019.parquet",
    "hdfs://master:9000/home/user/Assignment/Data/parquet/Crime_Data_from_2020_to_Present.parquet",
]

# read parquet files
df_old = spark.read.options(header=True, inferSchema=True).parquet(PATHS[0])
df_new = spark.read.options(header=True, inferSchema=True).parquet(PATHS[1])
